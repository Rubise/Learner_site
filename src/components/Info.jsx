...
function Info() {
  ...
  return (
    ...
    <div className='pb-20  md:w-[95%] my-0 mx-auto w-[88%] mt-30'>
        <div className='flex items-center justify-center flex-col'>
            ...
            <div className='flex gap-8 md:flex-row flex-col mt-10.5'>{
                howItWorks.map((pay) =>{
                    const Icon = pay.icon
                    return(
                    <div key={pay.id} className='flex flex-col items-center flex-1 shadow-[0_4px_30px_rgba(41,46,51,0.12)] p-8 rounded-2xl relative'>
